...
class ProductPhoto(models.Model):
    ...
    product = models.ManyToManyField(
        Product,
        through="ProductPhoto_Product",
        through_fields=("productPhoto", "product"),
    )
...
class FollowList(models.Model):
    ...
    product = models.ManyToManyField(
        Product, through="FollowList_Product", through_fields=("followList", "product")
    )
...
class ShoppingCart(models.Model):
    ...
    product = models.ManyToManyField(
        ...
        through_fields=("shoppingCart", "product"),
    )
...
class Order(models.Model):
    customer = models.OneToOneField(Customer, on_delete=models.CASCADE)
    product = models.ManyToManyField(
        Product, through="Order_Product", through_fields=("order", "product")
    )
...
class ShippingInfo(models.Model):
    ...
    shipping_status = models.CharField(
        default="undelivered", choices=shipping_status_list, max_length=20
    )
...
class PaymentInfo(models.Model):
    ...
    payment_status = models.CharField(
        default="unpaid", choices=payment_status_list, max_length=10
    )
